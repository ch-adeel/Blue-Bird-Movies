...
export default function Animation() {
    ...
    const getMovie= ()=>{
      fetch("https://api.themoviedb.org/3/movie/top_rated?api_key=a75a5cbd056e0be800689944d5bb8170")
      .then(res => res.json())
  ...
  return (
    <div>
      ...
      <div className="w-full bg-gradient-to-r from-red-500 to-fuchsia-500 md:p-18 mb-20 md:mb-0">

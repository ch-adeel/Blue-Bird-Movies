...
export default function Crime() {
    ...
    const getMovie=()=>{
        fetch("https://api.themoviedb.org/3/tv/top_rated?api_key=a75a5cbd056e0be800689944d5bb8170")
        .then(res => res.json())
  ...
  return (
    ...
    <div className="w-full bg-gradient-to-br from-cyan-900 to-red-900 md:p-18 mb-20 md:mb-0">

...
export default function Adventure() {
    ...
    const getMovie= ()=>{
      fetch("https://api.themoviedb.org/3/movie/popular?api_key=a75a5cbd056e0be800689944d5bb8170")
      .then(res => res.json())
  ...
  return (
    <div>
      ...
      <div className="w-full bg-gradient-to-l from-blue-500 to-black md:p-18 mb-20 md:mb-0">

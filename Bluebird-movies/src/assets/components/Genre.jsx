...
export default function Genre() {
  ...
  return (
    <div>
      ...
      <div className="w-full bg-gradient-to-r from-cyan-500 to-fuchsia-500  h-[10rem]">
      ...
      <div className="w-full bg-gradient-to-br from-rose-500 to-cyan-500 md:p-18 mb-20 md:mb-0">
